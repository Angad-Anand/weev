...
--
select * from twimagedata

LOCK TABLES `twimagedata` WRITE;
/*!40000 ALTER TABLE `twimagedata` DISABLE KEYS */;
INSERT INTO `twimagedata` VALUES  (
    1, 1, 
    '../../../assets/images/2W/S1 air', 
    '', '', 
    'ola-S1 air-White', 
    'ola-S1 air-Jet Black', 
    '', '', 
    'ola-S1 air-Neo Mint', 
  ...
  (
    2, 2, 
    '../../../assets/images/2W/S1 air', 
    'ola-S1-Anthracite Grey', '', 
    'ola-S1-Porcelain White', 
    '', '', 
    'ola-S1-Coral Glam', 
    '', '', '', '', '', '', '', ''
  ),
  (
    3, 3, 
    '../../../assets/images/2W/S1 Pro', 
    'ola-S1-Pro-Anthracite Grey', 
    '', 
    'ola-S1-Pro-Porcelain White', 
    '', '', 
    'ola-S1 Pro-coral Glam', 
    'ola-S1 Pro-Midnight Blue', 
    'ola-S1 Pro-liquid silver', 
    'ola-S1 Pro-Marshmellow', 
    'ola-S1 Pro-Millenial Pink', 
    'ola-S1 Pro-Khaki- Freedom Edition', 
    'ola-S1 Pro-Gerua', 
    '', ''
  ),
  (
    4, 4, 
    '../../../assets/images/2W/Ather', 
    'Ather-Lunar Grey', 
    'Ather-Space Grey', 
    'Ather-Still white', 
    'Ather-Cosmic Black', 
  ...
  (
    ...
    'TVS-iQube-Mint Blue', 
    '', 
    'TVS-iQube-Lucid Yellow', 
    '', '', '', '', 
    'TVS-iQube-Copper bronze'
  ),
  (
    7, 7, 
    '../../../assets/images/2W/CZAR', 
    'TVS-Evium-CZAR-Pearl Grey', 
    '', 
    'TVS-Evium-CZAR-Moonlight White', 
    'TVS-Evium-CZAR-Cold Black', 
    'TVS-Evium-CZAR-Argent Black', 
    'TVS-Evium-CZAR-Satin Red', 
    'TVS-Evium-CZAR-Hazy Blue', 
    '', 
    'TVS-Evium-CZAR-Auroral Yellow', 
    '', 
    'TVS-Evium-CZAR-Minted Green', 
    '', '', ''
  ),
  (
    8, 8, 
  ...
  (
    10, 10, 
    '../../../assets/images/2W/Chetak Premium', 
    'Bajaj-Chetak Premium-Hazel nut', 
    '', '', 
    'Bajaj-Chetak Premium-Brooklun Black', 
    '', '', 
    'Bajaj-Chetak Premium-Indigo Metallic', 
    '', '', '', '', '', '', ''
  ),
  (
    11, 11, 
    '../../../assets/images/2W/Chetak Premium 2023', 
    'Bajaj-Chetak Premium 2023-Matte Coarse Grey', 
    '', '', '', '', '', 
    'Bajaj-Chetak Premium 2023-Matte Carebbean Blue', 
    '', '', '', '', '', '', ''
  ),
  (
    12, 12, 
    '../../../assets/images/2W/Vida', 
    '', '', 
    'Hero -Vida-White', 
    '', '', 
    'Hero -Vida-Red', 
  ...
  (
    14, 14, 
    '../../../assets/images/2W/One', 
    '', '', 
    'Simple-one-grace white', 
    'Simple-One-brazen black', 
    '', 
    'Simple-One-azure- namma red', 
    'Simple-One-azure- blue', 
    '', '', '', '', '', '', ''
  ),
  (
    15, 15, 
  ...
  (
    18, 18, 
    '../../../assets/images/2W/Ampere', 
    'Ampere-Magnus EX-Galactic Grey', 
    '', 
    'Ampere-Magnus EX-Glacial White', 
    'Ampere-Magnus EX-Graphite Black', 
    '', 
    'Ampere-Magnus EX-Metallic Red', 
    'Ampere-Magnus EX-Ocean Blue', 
    '', '', '', '', '', '', ''
  ),
  (
    19, 19, 
    '../../../assets/images/2W/PraisePro', 
    '', '', '', 
    'Okinawa-PrasePro-Sparkle Black', 
    '', 
    'Okinawa-PrasePro-Glosy Red Black', 
    'Okinawa-PrasePro-Sparkle Blue', 
    '', '', '', 
    'Okinawa-PrasePro-Seafoam Green/Okinawa-PrasePro-Military Green', 
    '', 
    'Okinawa-PrasePro-Sun Orange', 
    'Okinawa-PrasePro-Mocha Brown'
  ),
  (
    20, 20, 
    '../../../assets/images/2W/Rorr', 
    '', '', '', '', '', 
    'Oben-Rorr-Electric Red', 
    '', '', 
    'Oben-Rorr-Voltaic Yellow', 
    '', '', '', '', ''
  ),
  (
    21, 21, 
    '../../../assets/images/2W/KM 4000', 
    '', '', '', '', '', '', '', '', '', '', 
    'Kabira Mobility-KM 4000-Green', 
    '', '', ''
  ),
  (
    22, 22, 
    '../../../assets/images/2W/Evoqis', 
    '', '', 
    'Odysse-Evoqis-Magna White', 
    'Odysse-Evoqis-Black', 
    '', 
    'Odysse-Evoqis-Fire Red', 
    'Odysse-Evoqis-Cobalt Blue', 
    '', '', '', 
    'Odysse-Evoqis-Lime Green', 
    '', '', ''
  ),
  (
    23, 23, 
    '../../../assets/images/2W/KM 3000', 
    '', '', '', '', '', 
    'Kabira Mobility-KM 3000-Red', 
    '', '', '', '', '', '', '', ''
  ),
  (
    24, 24, 
    '../../../assets/images/2W/Atum Vader', 
    'Atumobile-Atum vader-Grey', 
    '', 
    'Atumobile-Atum vader-White', 
    'Atumobile-Atum vader-Black', 
    '', 
    'Atumobile-Atum vader-Red', 
    'Atumobile-Atum vader-Blue', 
    '', '', '', '', '', '', ''
  ),
  (
    25, 25, 
  ...
  (
    26, 26, 
    '../../../assets/images/2W/Atum 1.0', 
    'Atumobile-Atum 1.0-Grey', 
    '', 
    'Atumobile-Atum 1.0-White', 
    'Atumobile-Atum 1.0-Black', 
    '', 
    'Atumobile-Atum 1.0-Red', 
    'Atumobile-Atum 1.0-Blue', 
    '', '', '', '', '', '', ''
  ),
  (
    27, 27, 
    '../../../assets/images/2W/eTryst 350', 
    '', '', '', '', '', '', '', '', '', '', '', '', '', ''
  );
...
BEGIN
	SELECT TWId, Manufacturer, Model, Variant, VariantType, ExShowroomPrice, MaxSpeed,
           ...
           CONCAT(twi.Path,'/',twi.main ,'.jpeg') Path
...
BEGIN
    ...
    /* CONCAT(Path,'/',MainImage ,'.jpeg') Main, */
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetTwimageTabNameByTWId`(
IN Id Int
)
BEGIN
...
BEGIN
	SELECT TWId, Manufacturer, Model, Variant, VariantType, ExShowroomPrice, MaxSpeed,
           ...
           BatteryWarrantyForMonths, BatteryWarrantyForKm, WaterProofRating, SuspensionFront,
           SuspensionRear, BrakesFront, BrakesRear, TyreSize, WheelSize, WheelsType ,OurRating ,           
 CONCAT(twi.Path, '/', twi.grey1, '.jpeg') AS Path
FROM 
    twowheelerdata twd
INNER JOIN 
    twimagedata_integer_images twi
ON 
